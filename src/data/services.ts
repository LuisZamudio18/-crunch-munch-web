    ...
    selectionGroups: [
      {
        ...
        totalMax: 3,
        options: [
          'Margarita fresa', 'Margarita clásica', 'Margarita mango', 'Margarita azul',
          'Mezcalita jamaica', 'Mezcalita piña', 'Mezcalita maracuya', 'Mezcalita fresa',
          'Mojito clásico', 'Mojito fresa', 'Mojito frutos rojos',
          'Gin tonic', 'Gin frutos rojos',
          'Tequila sunrise', 'Paloma', 'Paloma sandía',
          'Daiquiri fresa', 'Daiquiri mango',
          'Piña colada', 'Laguna azul', 'Sex on the beach',
