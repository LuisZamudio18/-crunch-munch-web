...
export default function Home() {
  ...
  function handleSelectService(id: string, selections?: Record<string, string[]>) {
    if (!configurator.selectedServices.includes(id)) {
      configurator.toggleService(id);
    }
    if (selections) {
      configurator.applyServiceSelections(id, selections);
    }
    configurator.open();
  }
  ...
  return (
    <>
      <Navbar onOpenConfigurator={configurator.open} />

      <main>
        <Hero onOpenConfigurator={configurator.open} />
        <About />
        <ServicesSection
          onOpenConfigurator={configurator.open}
      ...
      <ConfiguratorModal
        isOpen={configurator.isOpen}
        step={configurator.step}
        setStep={configurator.setStep}
        selectedServices={configurator.selectedServices}
        toggleService={configurator.toggleService}
        serviceSelections={configurator.serviceSelections}
        addGroupSelection={configurator.addGroupSelection}
        removeGroupSelection={configurator.removeGroupSelection}
        setGroupSelection={configurator.setGroupSelection}
        personalization={configurator.personalization}
        setPersonalization={configurator.setPersonalization}
        eventForm={configurator.eventForm}
        setEventForm={configurator.setEventForm}
